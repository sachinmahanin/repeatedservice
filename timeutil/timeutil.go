...
// FormatDateTime returns the time in string format "yyyy-MM-dd HH:mm:ss"
func FormatDateTime(value time.Time) string {
	return value.Format("2006-01-02 15:04:05")
}

// FormatDateTimeDetailed returns the time in string format "yyyy-MM-dd HH:mm:ss.fff"
func FormatDateTimeDetailed(value time.Time) string {
	return value.Format("2006-01-02 15:04:05.000")
}

// FormatDateTimeISO returns the time in string format "yyyy-MM-ddTHH:mm:ss"
func FormatDateTimeISO(value time.Time) string {
